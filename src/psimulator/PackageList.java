...
public class PackageList {
     ...
     * @return The classes
     */
    public static Class[] getClassesInPackageA(String packageName, String regexFilter) {
        List<Class> classes = getClassesInPackage(packageName, regexFilter);
    ...
    public static Class[] getClassesInPackageA(String packageName) {
        return getClassesInPackageA(packageName, null);
    }
